 ...
 * Generated at: 2016-01-27 06:15:26 UTC
...
}else userName = (String) session.getAttribute("name"); */ 
...
for(Cookie cookie : cookies){
    if(cookie.getName().equals("name")) userName = cookie.getValue();
      ...
      out.write("<!-- LogoutServlet is invoked when client clicks on Logout button in any of the JSP pages. -->\r\n");
