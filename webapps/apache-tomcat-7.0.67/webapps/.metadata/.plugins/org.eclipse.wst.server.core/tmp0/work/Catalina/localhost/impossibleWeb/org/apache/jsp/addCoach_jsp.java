 ...
 * Generated at: 2016-01-20 06:17:05 UTC
...
String hourlyrate = request.getParameter("cHourlyRate");
...
st.executeUpdate("INSERT INTO `coach`(`coach_id`, `coach_hourly_rate`, `coach_profile`) VALUES ('"+name+"','"+hourlyrate+"',"+description+"')");
